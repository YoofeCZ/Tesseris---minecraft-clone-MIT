...
void main()
{
    ...
    // ROZBALIT SE MUSI I TADY, i kdyz vitr resi chunk_wind.vert.
    //
    // Rostliny jdou do vyrezoveho bufferu, ale kdyz ten neni k dispozici, mesher je posle
    // do pruhledneho - a ten jede pres tenhle shader. Bez rozbaleni by rostlina s priznakem
    // clanku dostala nekolikanasobne prepaleny jas a falesne "pod vodou".
    float shade;
    float submerged;
    float segment;
    float total;
